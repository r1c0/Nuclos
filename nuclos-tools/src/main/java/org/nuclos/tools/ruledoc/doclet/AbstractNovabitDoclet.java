 ...
 */
public abstract class AbstractNovabitDoclet {
	 ...
	 */
	private static final String TOOLKIT_DOCLET_NAME = CommonDoclet.class.getName();

	/**
	 * Verify that the only doclet that is using this toolkit is
	 * {@value TOOLKIT_DOCLET_NAME}.
	 */
	private boolean isValidDoclet(AbstractNovabitDoclet doclet) {
	 ...
	 */
	public boolean start(AbstractNovabitDoclet doclet, RootDoc root) {
