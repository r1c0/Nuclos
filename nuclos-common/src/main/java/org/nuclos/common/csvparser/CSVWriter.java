...
public class CSVWriter {
	 ...
	 * @param quoteLevel 0 = minimal quotes
	 ...
	 * @param quote		char to use to enclose fields containing a separator,
	 *                   usually '\"'
	...
	public void put(String s) {
		...
		if (s == null) {
			//nl();//Auskommentiert, da Feld beschrieben werden muss wenn null.
			s = "";
			//return;//s.o.
		}
