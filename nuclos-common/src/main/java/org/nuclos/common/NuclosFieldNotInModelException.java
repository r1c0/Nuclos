...
public class NuclosFieldNotInModelException extends CommonFatalException {
	 ...
	 */
	public NuclosFieldNotInModelException(Throwable tCause) {
		super(tCause);
	}
	 ...
	 */
	public NuclosFieldNotInModelException(String sMessage) {
		super(sMessage);
	}
	 ...
	 * @param tCause wrapped exception
	 */
	public NuclosFieldNotInModelException(String sMessage, Throwable tCause) {
