...
/**
 * Wrapper exception for finder exception.
 * <br>
...
public class CommonFinderException extends CommonBusinessException {
	 ...
	 */
	public CommonFinderException(Throwable tCause) {
		super(CommonBusinessException.FINDER, tCause);
	}

	/**
	 * @param sMessage exception message
	 */
	public CommonFinderException(String sMessage) {
		super(sMessage);
	}
	 ...
	 * @param tCause wrapped exception
	 */
	public CommonFinderException(String sMessage, Throwable tCause) {
