 ...
 * @version 01.00.00
 */
public final class DependantMasterDataMapImpl implements Serializable, DependantMasterDataMap {

	private static final Logger log = Logger.getLogger(DependantMasterDataMapImpl.class);
	 ...
	 */
	public DependantMasterDataMapImpl() {
	}
	 ...
	 */
	@Deprecated
	public DependantMasterDataMapImpl(String sDependantEntityName, Collection<MasterDataVO> collmdvoDependants) {
	 ...
	 * @postcondition this.get(sDependantEntityName).equals(collmdvoDependants)
	 */
	public DependantMasterDataMapImpl(String sDependantEntityName, List<EntityObjectVO> collmdvoDependants) {
