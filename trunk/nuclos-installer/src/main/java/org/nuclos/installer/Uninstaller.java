...
public class Uninstaller extends AbstractLauncher {

	@Override
	public void run(Installer i, Unpacker u) throws InstallException {
		if (u.isProductRegistered() && !u.isPrivileged()) {
			i.error("error.remove.privileged.required");
		}
		i.uninstall(u);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		Uninstaller main = new Uninstaller();
		main.run(args);
	}
}
