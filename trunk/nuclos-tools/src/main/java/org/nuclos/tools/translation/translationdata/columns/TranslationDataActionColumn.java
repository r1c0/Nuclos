...
public class TranslationDataActionColumn extends TranslationDataColumn {
   ...
   public Object getValueAt(TranslationData td) {
      return td.getAction().getName();
   }

	@Override
   public void setValueAt(Object value, TranslationData td) {
      td.setAction(TranslationAction.getByName((String)value));
   }
