...
public class BigDate implements Cloneable, java.io.Serializable, Comparable<BigDate> {
	...
	public final int compareTo(BigDate anotherBigDate) {
		return this.ordinal - anotherBigDate.ordinal;
	}
	 ...
	 * Not compatiblse with BigDate.getDayOfWeek.
	 * @see #isoDayOfWeek
	 * @see #dayOfWeek
	 ...
	 * @return day of week 1=Sunday 2=Monday 3=Tuesday 4=Wednesday 5=Thursday 6=Friday 7=Saturday
	 * Compatible with Sun's 1=Calendar.SUNDAY
	 * Not compatible with BigDate.getDayOfWee
	 * @see #getISODayOfWeek
	 * @see #getDayOfWeek
	 * @see #calendarDayOfWeek
	 */
	...
	public final int getSeason() {
		// 1 > 3, 2 > 3, 3 > 0, 4 > 0, 5 > 0, 6 > 1, 7 > 1, 8 > 1, 9 > 2, 10 > 2, 11 > 2, 12 > 3
		return ((mm + (12 - 3)) % 12) / 3;
	}
	...
	public final int getWeekNumber() {
		...
		int jan01DayOfWeek = dayOfWeek(jan01); // 0=Sunday  1=Monday 2=Tuesday 3=Wednesday 4=Thursday 5=Friday 6=Saturday
	...
	public void setDateAtTime(long utcTimestamp, TimeZone timeZone) {
		 ...
		 */
		//NUCLEUSINT-1158
		int millisDay = (int) (utcTimestamp % 86400000L);
		if (millisDay < 0)
			millisDay += 86400000;
	...
	public String toString() {
		...
		result = toLZ(dd, 2) + "." + toLZ(mm, 2) + "." + result;
		return result;
	} // end toString
	 ...
	 */
	private final static String toLZ(int i, int len) {
