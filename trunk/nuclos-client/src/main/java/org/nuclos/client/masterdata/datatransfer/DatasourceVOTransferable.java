...
public class DatasourceVOTransferable implements Transferable {
	 ...
	 * @param mdvo
	 */
	public DatasourceVOTransferable(DatasourceEntity aSourceEntity) {
		this.datasourceEntity = aSourceEntity;

		this.sText = datasourceEntity.getDatasourceVoList().get(0).getName();

		this.aflavors = new DataFlavor[] {
				new DatasourceEntity.DatasourceDataFlavor(),
	...
	public Object getTransferData(DataFlavor flavor) throws UnsupportedFlavorException {
		...
		if (flavor instanceof DatasourceEntity.DatasourceDataFlavor) {
			result = this.datasourceEntity;
		}
		else {
