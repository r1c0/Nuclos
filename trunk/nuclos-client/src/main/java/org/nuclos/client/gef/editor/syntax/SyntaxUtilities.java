 ...
 *
 * @author Slava Pestov
 * @version $Id: SyntaxUtilities.java,v 1.1 2007-05-11 08:18:09 radig Exp $
 */
public class SyntaxUtilities {
	...
	public static SyntaxStyle[] getDefaultSyntaxStyles() {
		...
		styles[Token.KEYWORD3] = new SyntaxStyle(new Color(0x650099), false, true);
		styles[Token.LITERAL1] = new SyntaxStyle(new Color(0x009600), false, false);
