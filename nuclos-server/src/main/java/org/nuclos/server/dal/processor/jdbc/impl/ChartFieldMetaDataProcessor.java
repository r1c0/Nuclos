...
public class ChartFieldMetaDataProcessor implements IDalReadSpecification<EntityFieldMetaDataVO> {
	private EntityMetaDataVO entity;
	
	public ChartFieldMetaDataProcessor(EntityMetaDataVO entity) {
	    this.entity = entity;
    }
    ...
    public List<EntityFieldMetaDataVO> getAll() {
		return new ArrayList<EntityFieldMetaDataVO>(
				ChartMetaDataProcessor.getInstance().getChartFieldsForView(
