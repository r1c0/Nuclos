...
public class EventNucletContent extends DefaultNucletContent {

	public EventNucletContent(List<INucletContent> contentTypes) {
		super(NuclosEntity.EVENT, null, contentTypes);
	}
