...
public class ActionNucletContent extends DefaultNucletContent {

	public ActionNucletContent(List<INucletContent> contentTypes) {
		super(NuclosEntity.ACTION, null, contentTypes);
	}
