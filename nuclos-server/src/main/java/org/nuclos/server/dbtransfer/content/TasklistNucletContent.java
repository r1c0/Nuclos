...
public class TasklistNucletContent extends DefaultNucletContent {

	public TasklistNucletContent(List<INucletContent> contentTypes) {
		super(NuclosEntity.TASKLIST, null, contentTypes);
	}
	...
	public List<EntityObjectVO> getNcObjects(Set<Long> nucletIds, TransferOption.Map transferOptions) {
		...
		for (EntityObjectVO ncObject : result) {
			storeLocaleResources(ncObject, "labelres", "descriptionres", "menupathres");
		}
		return result;
	}
