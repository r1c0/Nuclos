...
public class StateNucletContent extends DefaultNucletContent {

	public StateNucletContent(List<INucletContent> contentTypes) {
		super(NuclosEntity.STATE, NuclosEntity.STATEMODEL, contentTypes);
	}
