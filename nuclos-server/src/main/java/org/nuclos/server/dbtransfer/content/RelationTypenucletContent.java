...
public class RelationTypenucletContent extends DefaultNucletContent {

	public RelationTypenucletContent(List<INucletContent> contentTypes) {
		super(NuclosEntity.RELATIONTYPE, null, contentTypes);
	}
	...
	public List<EntityObjectVO> getNcObjects(Set<Long> nucletIds, TransferOption.Map transferOptions) {
		...
		for (EntityObjectVO ncObject : result) {
			storeLocaleResources(ncObject, "labelres");
		}
		return result;
	}
