...
public class EntitySubnodesNucletContent extends DefaultNucletContent {

	public EntitySubnodesNucletContent(List<INucletContent> contentTypes) {
		super(NuclosEntity.ENTITYSUBNODES, NuclosEntity.ENTITY, contentTypes);
	}
	...
	public List<EntityObjectVO> getNcObjects(Set<Long> nucletIds, TransferOption.Map transferOptions) {
		...
		for (EntityObjectVO ncObject : result) {
			storeLocaleResources(ncObject, EntityTreeViewVO.FOLDERNAME_FIELD);
		}
		return result;
	}
