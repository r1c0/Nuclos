 ...
 * @version 01.00.00
 */
public class WYSIWYGCollectableEmail extends WYSIWYGCollectableComponent {

	private WYSIWYGLabeledEmail component = new WYSIWYGLabeledEmail();

	public WYSIWYGCollectableEmail() {
