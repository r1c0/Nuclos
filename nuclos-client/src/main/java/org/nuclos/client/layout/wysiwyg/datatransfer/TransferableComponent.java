...
public class TransferableComponent implements Transferable {
	 ...
	 * Element to transfer
	 */
	private transient WYSIWYGComponent element;
	
	public final static DataFlavor flavor = new DataFlavor(WYSIWYGComponent.class, "Element");
	 ...
	 * NUCLEUSINT-496
	 */
	public TransferableComponent(WYSIWYGComponent element) {
