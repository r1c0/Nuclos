...
/**
 * Small {@link ItemListener} for saving the field parameter-for-sourcecomponent
 * @author hartmut.beckschulze
 *
 */
public class ParameterForSourceComponentAwareItemListener implements ItemListener{
	 ...
	 */
	public ParameterForSourceComponentAwareItemListener(LayoutMLRuleAction layoutMLRuleAction) {
	...
	public void itemStateChanged(ItemEvent e) {
		if (e.getStateChange() == ItemEvent.SELECTED) {
			layoutMLRuleAction.setParameterForSourceComponent(e.getItem().toString());
		}
	}
