...
/**
 * Small {@link ItemListener} for saving the sourcefield in the {@link LayoutMLRuleAction}
 * @author hartmut.beckschulze
 *
 */
public class SourceFieldActionAwareItemListener implements ItemListener{
	 ...
	 */
	public SourceFieldActionAwareItemListener(LayoutMLRuleAction layoutMLRuleAction) {
	...
	public void itemStateChanged(ItemEvent e) {
		if (e.getStateChange() == ItemEvent.SELECTED) {
			layoutMLRuleAction.setSourceField(e.getItem().toString());
		}
	}
}
