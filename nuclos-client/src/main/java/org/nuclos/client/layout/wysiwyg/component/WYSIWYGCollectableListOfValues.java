...
public class WYSIWYGCollectableListOfValues extends WYSIWYGCollectableComponent {
	...
	private LabeledListOfValues component = new WYSIWYGLabeledListOfValues();
	...
	public void setName(String name) {
		if (component != null) {
			component.getListOfValues().getJTextField().setText(name);
		}
	}
	...
	private static class WYSIWYGLabeledListOfValues extends LabeledListOfValues {
			...
			support.setColorProvider(new ColorProvider() {
				...
				public Color getColor(Color colorDefault) {
					if (backgroundcolor == null && !NuclosThemeSettings.BACKGROUND_PANEL.equals(colorDefault)) {
						if (getListOfValues().getJTextField().isEditable()) {
							return Color.WHITE;
						} else {
