...
public class WYSIWYGSubFormColumn extends JLabel implements WYSIWYGComponent, Serializable, WYSIWYGEditorModes {
	...
	private static PropertyFilter[] PROPERTY_FILTERS = new PropertyFilter[] {
		...
		new PropertyFilter(PROPERTY_VISIBLE, ENABLED),
		new PropertyFilter(PROPERTY_INSERTABLE, ENABLED),
		new PropertyFilter(PROPERTY_CONTROLTYPE, ENABLED),
		new PropertyFilter(PROPERTY_CONTROLTYPECLASS, ENABLED),
		...
		new PropertyFilter(PROPERTY_COLUMNWIDTH, ENABLED),
		new PropertyFilter(PROPERTY_NEXTFOCUSCOMPONENT, ENABLED),
		new PropertyFilter(PROPERTY_COLLECTABLECOMPONENTPROPERTY, ENABLED)
	};
