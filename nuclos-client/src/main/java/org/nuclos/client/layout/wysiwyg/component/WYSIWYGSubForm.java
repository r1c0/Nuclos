...
public class WYSIWYGSubForm extends JLayeredPane implements WYSIWYGComponent, MouseListener {
	...
	public static final String[][] PROPERTY_VALUES_STATIC = new String[][]{{PROPERTY_TOOLBARORIENTATION, ATTRIBUTEVALUE_HORIZONTAL, ATTRIBUTEVALUE_VERTICAL}};
	...
	private static PropertyFilter[] PROPERTY_FILTERS = new PropertyFilter[]{
			...
			new PropertyFilter(PROPERTY_UNIQUEMASTERCOLUMN, STANDARD_MODE | EXPERT_MODE),
		...
		try {
			if (entityname != null) {
				...
				if (!StringUtils.isNullOrEmpty(sorientation)) {
					orientation = sorientation.equals(ATTRIBUTEVALUE_VERTICAL) ? JToolBar.VERTICAL : JToolBar.HORIZONTAL;
				}
