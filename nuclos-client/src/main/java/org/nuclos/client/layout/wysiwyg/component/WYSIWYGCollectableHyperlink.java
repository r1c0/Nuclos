 ...
 * @version 01.00.00
 */
public class WYSIWYGCollectableHyperlink extends WYSIWYGCollectableComponent {

	private WYSIWYGLabeledHyperlink component = new WYSIWYGLabeledHyperlink();

	public WYSIWYGCollectableHyperlink() {
