...
public class ChartCollectController extends AbstractDatasourceCollectController<ChartVO> implements DatasourceEditController {
	...
	@Override
	public CollectableDataSource<ChartVO> findCollectableById(String sEntity, Object oId) throws CommonBusinessException {
		return new CollectableDataSource<ChartVO>(datasourcedelegate.getChart((Integer) oId));
	}
	...
	public CollectableDataSource<ChartVO> newCollectable() {
		return new CollectableDataSource<ChartVO>(new ChartVO(null, null, null, null, null, null));
	}
	...
	protected List<DatasourceParameterVO> getDefaultParameters() {
		...
		final DatasourceParameterVO INTID_T_UD_GENERICOBJECT = new DatasourceParameterVO(
				null, "genericObject", QueryBuilderConstants.PARAMETER_TYPE_INTEGER, null);
		result.add(INTID_T_UD_GENERICOBJECT);
