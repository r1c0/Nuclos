...
public class DatasourceCollectController extends AbstractDatasourceCollectController implements DatasourceEditController {
	...
	public CollectableDataSource findCollectableById(String sEntity, Object oId) throws CommonBusinessException {
		return new CollectableDataSource(datasourcedelegate.getDatasource((Integer) oId));
	}
	...
	public CollectableDataSource newCollectable() {
		return new CollectableDataSource(new DatasourceVO(null, null, null, null, null));
	}
	...
	protected void deleteCollectable(CollectableDataSource clct) throws CommonBusinessException {
		...
		datasourcedelegate.removeDatasource(clct.getDatasourceVO());
	...
	protected CollectableDataSource updateCurrentCollectable(CollectableDataSource clctEdited) throws CommonBusinessException {
		...
		final DatasourceVO datasourceVOUpdated = datasourcedelegate.modifyDatasource(datasourceVO, lstUsedDatasources);
	...
	protected CollectableDataSource insertCollectable(CollectableDataSource clctNew) throws CommonBusinessException {
		...
		final DatasourceVO datasourceVO = datasourcedelegate.createDatasource(clctNew.getDatasourceVO(),
