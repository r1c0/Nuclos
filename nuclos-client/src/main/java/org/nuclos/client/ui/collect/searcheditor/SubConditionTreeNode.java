...
/**
 * <code>TreeNode</code> that contains a <code>CollectableSubCondition</code>.
 * <br>
...
public class SubConditionTreeNode extends SearchConditionTreeNode {
	 ...
	 */
	public SubConditionTreeNode(CollectableSubCondition cond) {
		this.clcteSub = cond.getSubEntity();
		this.sForeignKeyFieldName = cond.getForeignKeyFieldName();
		this.setSubCondition(cond.getSubCondition());
	}

	@Override
	protected String getLabelForExpandedState() {
		return "EXISTIERT " + clcteSub.getLabel() + " MIT";
	}

	public CollectableEntity getSubEntity() {
		return this.clcteSub;
	}
	...
	@Override
	public CollectableSubCondition getSearchCondition() {
		return new CollectableSubCondition(this.getSubEntity().getName(), this.sForeignKeyFieldName, this.getSubCondition());
	}
