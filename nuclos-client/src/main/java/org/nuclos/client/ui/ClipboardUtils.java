...
public class ClipboardUtils {
	...
	public static class CutAction extends DefaultEditorKit.CutAction {
		...
		public CutAction() {
			...
			this.putValue(SHORT_DESCRIPTION, SpringLocaleDelegate.getInstance().getMessage("ClipboardUtils.Cut", "Ausschneiden"));
	...
	public static class CopyAction extends DefaultEditorKit.CopyAction {
		...
		public CopyAction() {
			...
			this.putValue(SHORT_DESCRIPTION, SpringLocaleDelegate.getInstance().getMessage("ClipboardUtils.Copy", "Kopieren"));
	...
	public static class PasteAction extends DefaultEditorKit.PasteAction {
		...
		public PasteAction() {
			...
			this.putValue(SHORT_DESCRIPTION, SpringLocaleDelegate.getInstance().getMessage("ClipboardUtils.Paste", "Einf\u00fcgen"));
