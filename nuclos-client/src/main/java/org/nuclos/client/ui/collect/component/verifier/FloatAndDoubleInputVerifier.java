...
public class FloatAndDoubleInputVerifier extends InputVerifier {
	...
	public FloatAndDoubleInputVerifier(CollectableEntityField clctef) {
		if (clctef == null) {
	...
	public boolean verify(JComponent comp) {
		...
		try {
			final Class<?> clazz = clctef.getJavaClass();
