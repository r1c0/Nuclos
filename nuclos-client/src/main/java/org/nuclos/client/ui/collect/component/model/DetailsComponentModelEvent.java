...
/**
 * An event that may occur on a <code>DetailsComponentModel</code>.
 * <br>
...
public class DetailsComponentModelEvent extends CollectableComponentModelEvent {
	...
	public DetailsComponentModelEvent(CollectableComponentModel source, boolean bValueToBeChanged) {
		...
		this.bValueToBeChanged = bValueToBeChanged;
	}
	...
	public boolean isValueToBeChanged() {
		return this.bValueToBeChanged;
	}

}  // class DetailsComponentModelEvent
