...
public class DynamicEntitySearchStrategy extends CollectSearchStrategy<CollectableDataSource<DynamicEntityVO>> {
	...
	public void search() {
		...
		try {
			...
			List<CollectableDataSource<DynamicEntityVO>> result = CollectionUtils.transform(this.datasourcedelegate.getAllDynamicEntities(),
					new CollectableDataSource.MakeCollectable<DynamicEntityVO>());
