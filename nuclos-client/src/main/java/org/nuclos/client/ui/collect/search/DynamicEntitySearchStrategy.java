...
public class DynamicEntitySearchStrategy extends CollectSearchStrategy<CollectableDataSource> {
	...
	public void search() {
		...
		try {
			...
			cc.fillResultPanel(CollectionUtils.transform(this.datasourcedelegate.getAllDynamicEntities(),
