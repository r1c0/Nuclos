	...
	public static class Entity extends AbstractCollectableEntity {
		private Entity() {
			...
			this.addCollectableEntityField(new DefaultCollectableEntityField(FIELDNAME_TASK, String.class, 
					...
					getSpringLocaleDelegate().getMessage("CollectableTaskOwner.2","Aufgabe"), 255, null, false, CollectableField.TYPE_VALUEIDFIELD, "__task",
			...
			this.addCollectableEntityField(new TaskOwnerCollectableEntityField(FIELDNAME_USER, String.class, 
					...
					getSpringLocaleDelegate().getMessage("CollectableTaskOwner.3","Bearbeiter der Aufgabe"), 255, false, CollectableField.TYPE_VALUEIDFIELD, NuclosEntity.USER.getEntityName(),
